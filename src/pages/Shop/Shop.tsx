...
import ProductCard from '../../components/ProductCard/ProductCard'; // Импорт нового компонента
import './Shop.css';
...
const Shop: React.FC = () => {
    ...
    useEffect(() => {
        const shopPage = document.querySelector<HTMLElement>(
    ...
    const handleAddToWishlist = useCallback((productName: string) => {
                ...
                {state.isLoading ? (
                    ...
                    <>
                        ...
                        <div className="products-meta">
                            ...
                            {activeFiltersCount > 0 && (
                                <button className="quick-reset-link" onClick={clearFilters} type="button">
                                    Сбросить всё
                                </button>
                            )}
                        </div>
                        ...
                        {filteredAndSortedProducts.length === 0 ? (
                            <div className="no-products" role="status">
                                ...
                                {activeFiltersCount > 0 && (
                                    <button className="reset-filters-btn" onClick={clearFilters} type="button">
                                        Сбросить фильтры
                                    </button>
                                )}
                            </div>
